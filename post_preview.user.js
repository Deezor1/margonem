...
(() => {
    ...
    if(b.innerHTML.indexOf("i") == 1 || b.innerHTML.indexOf("f") == 6){
        ...
        but.appendChild(document.createTextNode('Podgląd'));
        b.appendChild(but);
        ...
        but.addEventListener('click', (e) => {
            ...
            c = c.replace(/ITEM#.+?(?= )|ITEM#.+?$/g, ' <img src="https://raw.githubusercontent.com/Deezor1/margonem/master/item_template.png" align="left">');
